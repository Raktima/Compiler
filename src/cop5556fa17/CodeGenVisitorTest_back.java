...
public class CodeGenVisitorTest {
	...
	public void prog10() throws Exception {
		...
		show(input);
		byte[] bytecode = genCode(input);		
		String[] commandLineArgs = {"false", "false"}; //create command line argument array to initialize params, none in this case		
		runCode(prog, bytecode, commandLineArgs);	
		show("Log:\n"+RuntimeLog.globalLog);
...
//		runCode(prog, bytecode, commandLineArgs);	
//		show("Log:\n"+RuntimeLog.globalLog);
//		assertEquals("entering main;11;20;true;true;leaving main;",RuntimeLog.globalLog.toString());
//	}
